...
//        super();
//    }
//    public Vats(String comment, String iso_duplicate, String country, Double standard_rate, Double reduced_rate, Double reduced_rate_alt, Boolean super_reduced_rate, Boolean parking_rate) {
//        this(iso_duplicate, country, standard_rate, reduced_rate, reduced_rate_alt, super_reduced_rate, parking_rate);
//        this.comment = comment;
//    }
//    public Vats(String iso_duplicate, String country, Double standard_rate, Double reduced_rate, Double reduced_rate_alt, Boolean super_reduced_rate, Boolean parking_rate) {
//        this(country, standard_rate, reduced_rate, reduced_rate_alt, super_reduced_rate, parking_rate);
//        this.iso_duplicate = iso_duplicate;
//    }
//    public Vats(String country, Double standard_rate, Double reduced_rate, Double reduced_rate_alt, Boolean super_reduced_rate, Boolean parking_rate) {
