...
public class AT {
    ...
    public AT(String comment, String iso_duplicate, String country, Double standard_rate, Double reduced_rate, Double reduced_rate_alt, Boolean super_reduced_rate, Boolean parking_rate) {
